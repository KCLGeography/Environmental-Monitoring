...
/* ALARM SUBROUTINE. NOTE TEST/DEPLOYMENT OPTIONS BELOW! */
void set_alarm(void){


    //TEST CODE. COMMENT OUT FOR ACTUAL DEPLOYMENT.
    uint8_t flags[5] = { 0, 0, 0, 1, 1 };
    DS3234_set_a1(ss, wake_SECOND, 0, 0, 0, flags);
    DS3234_set_creg(ss, DS3234_INTCN | DS3234_A1IE);

    //DEPLOYMENT CODE. COMMENT IN THE BELOW FOR ACTUAL DEPLOYMENT.
